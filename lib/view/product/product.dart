...
import 'package:yerp/view/product/add_product.dart';
import 'package:yerp/view/product/manage_product.dart';
    ...
    return CustomScaffold(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: ViewTabs(tabLength: 2, listOfTabs: [
              CustomTabBar(barName: 'addProduct'),
              CustomTabBar(barName: 'manageProduct'),
            ], listOfView: [
              AddProduct(),
              ManageProduct(),
            ]),
